...
const initialValuesRegister: IValues = {
  firstName: '',
  lastName: '',
  email: '',
  password: '',
...
const initialValuesLogin: IValues = {
  email: '',
  password: '',
}
...
const Form = () => {
  ...
  const register = async (
    ...
    formData.append('pathPicture', values.picture?.name as string)
                ...
                >
                  <Dropzone
                    ...
                    onDrop={(acceptedFiles) =>
                      setFieldValue('picture', acceptedFiles[0] as File)
                    }
                  >
